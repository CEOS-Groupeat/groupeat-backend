...
public class AuthController {
    ...
    public ApiResponse<AuthenticatedMemberResponse> me(
        ...
        return ApiResponse.onSuccess(AuthenticatedMemberResponse.from(member));
    }
    ...
    public ApiResponse<TokenReissueResponse> reissue(
        ...
        return ApiResponse.onSuccess(new TokenReissueResponse("Access token이 재발급되었습니다."));
    }
    ...
    public ApiResponse<LogoutResponse> logout(HttpServletResponse response) {
        ...
        return ApiResponse.onSuccess(new LogoutResponse("로그아웃되었습니다."));
    }
}
